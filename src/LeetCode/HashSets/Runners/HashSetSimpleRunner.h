...
#include "LeetCode/HashSets/HashSetSimple.h"
...
namespace LeetCode::HashSet
{
    ...
    public:
        void run() override
        {
            std::unique_ptr<IHashSet> hs = std::make_unique<HashSetSimple>();
    ...
    REGISTER_SOLUTION_RUNNER("HashSetSimple", HashSetSimpleRunner)
}